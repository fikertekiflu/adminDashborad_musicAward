        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="col-span-full md:col-span-1">
              ...
              <textarea name="description" value={formData.description || ''} onChange={handleChange} className="mt-1 w-full rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white text-gray-900 placeholder:text-gray-400 text-sm py-3" placeholder="Enter description" rows={3} />
            </div>
            <div className="col-span-full md:col-span-1">
              <label className="text-sm font-medium text-gray-700 block mb-2">Sentence 1</label>
              <input type="text" name="sentence1" value={formData.sentence1 || ''} onChange={handleChange} className="mt-1 w-full rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white text-gray-900 placeholder:text-gray-400 text-sm py-3" placeholder="Enter sentence 1" />
            </div>
            <div className="col-span-full md:col-span-1">
              <label className="text-sm font-medium text-gray-700 block mb-2">Sentence 2</label>
              <input type="text" name="sentence2" value={formData.sentence2 || ''} onChange={handleChange} className="mt-1 w-full rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white text-gray-900 placeholder:text-gray-400 text-sm py-3" placeholder="Enter sentence 2" />
            </div>
          </div>
          <div className="flex justify-end gap-3 mt-8">
            <button variant="outline" onClick={() => { setShowForm(false); resetForm(); }} className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold px-6 py-3 rounded-lg transition-colors duration-200 shadow-md">
              <X className="mr-2 h-4 w-4" /> Cancel
            </button>
            <button type="submit" className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 shadow-md">
  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-8 flex justify-end">
        {!showForm && (
          <button onClick={() => setShowForm(true)} className="bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 shadow-md">
